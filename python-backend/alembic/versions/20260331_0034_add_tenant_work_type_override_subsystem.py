...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("vision_extractable", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("manual_override_allowed", sa.Boolean(), nullable=False, server_default=sa.text("true")),
